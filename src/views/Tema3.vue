          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              li.mb-2
                ...
                | Presenta baja permeabilidad frente a la humedad y gases.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Muy pesado y más frágil que otros materiales.
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Transparencia.
        ...
        .row(titulo="PLÁSTICO")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              ...
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Posibles transferencias de compuestos al producto.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Mayor adsorción y absorción de gases y vapores.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Menos transparencia.
              li
        ...
        .row(titulo="METALES")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Utilizado para envases de aerosoles a presión.
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
        ...
        .row(titulo="P.E.T.")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Alta ausencia de impurezas.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Baja permeabilidad al oxígeno y vapor de agua.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Resistente al golpe y agrietamiento.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Rígido.
              li.mb-2
        ...
        .row(titulo="P.E.A.D.")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Presentan gran rigidez y resistencia al golpe.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Casi sin la presencia de impurezas.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Ideal para potes de cremas.
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
        ...
        .row(titulo="P.E.B.D.")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              ...
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Ideal para preparaciones tópicas.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Resistente a preparaciones líquidas.
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
        ...
        .row(titulo="P.V.C.")
          ...
          .col-md-6
            ...
            ul.fa-ul.mt-3
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Es el tipo de envase que más problemas genera.
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Ha sido reemplazado por otros tipos de envases menos contaminantes.
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
    ...
    .cont_3_4.pt-5.mt-5
      .row
        ...
        .col-lg-8(style="place-self:center;")
          ...
          .cajon.color-secundario.p-4(style="background-color:#E4DDFA;")
            p.mb-0(data-aos="fade-up") Si no están a disposición los datos relacionados con la estabilidad del fármaco o de la preparación específica, es recomendable que se utilicen las siguientes fechas de vencimiento máximas para preparaciones magistrales no estériles, que son envasadas en envases tipo impermeables y que resisten la luz y se almacenan a unas temperaturas y ambientes controlados, a no ser que se tome una determine algo diferente.
            ...
            .p-4.pt-5
              ...
              ul.fa-ul.mb-0.mt-3
                li.mb-3(data-aos="fade-up")
                  i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                  | Las fechas de vencimiento debe ser menor a la duración de la terapia del paciente o 30 días, lo que ocurra primero.
                li(data-aos="fade-up")
                  i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
