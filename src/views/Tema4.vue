  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 4
      h1 Control de calidad de preparaciones magistrales no estériles
    ...
    .row.justify-content-center
      ...
      .col-lg-3(style="place-self:center;position:relative;")
        .cont_responsive2.p-4(style="position:relative;width:150%;background-color:#CDEDFC;border-radius:20px 20px 0px 20px;left:-200px;box-shadow:0px 0px 20px rgba(0,0,0,.2)")
          p(data-aos="fade-left") La calidad, eficacia y seguridad de las preparaciones magistrales no estériles, son consecuencia de los siguientes factores:
          ul.fa-ul.mb-0.mt-3
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | La correcta utilización de todos los ingredientes presentes en ella.
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | La realización correcta de cálculos.
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | La realización de mediciones precisas y exactas, contando con equipos y materiales adecuados. 
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | Contar con las condiciones y procedimientos operativos estándar adecuados.
            li(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | Prudente del criterio y ejercicio farmacéutico.  
    ...
    .row.justify-content-center.mt-5
      ...
      .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        figure.text-center
          img(src="@/assets/curso/tema4/2.svg" style="max-width:450px;display:inline;" alt="Imagen decorativa")
    
    .col-lg-6.mt-5.m-auto
      .titulo-sexto.color-acento-botones(data-aos="fade-right")
        h5 Figura 3
        span Etapas del control de calidad y su relación con los procesos
      figure
    ...
    p.mt-5(data-aos="fade-right") Es posible afirmar que existe una relación muy estrecha entre el control de calidad y los procesos del establecimiento farmacéutico (Farmacia-Droguería), donde se lleve a cabo la elaboración de las preparaciones magistrales.
    ...
    #t_4_1.titulo-segundo(data-aos="fade-right")
      h2 4.1 Métodos de ensayo
    
    p(data-aos="fade-right") Para tomar la decisión de los ensayos que serán aplicados a las preparaciones magistrales, y con el objetivo de conocer la calidad del producto terminado, es necesario consultar en las farmacopeas internacionales, debido a  que estas brindan patrones de referencia, especificaciones y métodos de ensayo validados que los analistas independientes pueden utilizar en el control de calidad.

    .row.justify-content-center.mt-5(style="position:relative;")
      .col-lg-8.order-lg-1.order-2(data-aos="fade-right")
        .cont_fondo1.p-4.pb-3(data-aos="fade-right")
          .d-flex
            div.me-2
              i.fas.fa-quote-left(style="color:#15D3EC;font-size:28px;")
            div
              p.fw-bold(style="font-size:22px;") Allí se definen las características que debe poseer un producto y se establecen los ensayos que permiten demostrar que el mismo satisface los requisitos mínimos de calidad exigidos por la autoridad sanitaria. Dichas normas se aplican en cualquier momento de la vida útil del producto, desde la elaboración hasta el vencimiento, y los resultados obtenidos se aplican exclusivamente al lote analizado #[i.fas.fa-quote-right(style="color:#15D3EC;font-size:28px;")]
              p.text-end.fw-bold - Manzano y Morales, 2003.  
      .col-lg-1
      .col-lg-3.col-6.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        div(style="position:absolute;right:0;bottom:0px;z-index:0;")
          img(src="@/assets/curso/tema4/7.png" style="width:550px;")
        figure.text-center
          img(src="@/assets/curso/tema4/8.png" style="display:inline;max-width:450px;z-index:1;position:relative;" alt="Imagen decorativa")

    .p-4.mt-5(style="background-color:#F7F6FE;")
      .col-lg-10.m-auto
        .row.justify-content-center
          .col-lg-5.col-10.mb-4.mb-lg-0(style="place-self:center;")
            figure.text-center
          ...
          .col-lg-7(style="place-self:center;")
            ...
            ul.fa-ul.mb-0.mt-3
              li.mb-2(data-aos="fade-left")
                ...
                | Prueba o ensayos de identificación del principio activo.
              li.mb-2(data-aos="fade-left")
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Valoración, uniformidad de dosis (UD).
              li(data-aos="fade-left")
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | La prueba de disolución. 
    
    p.mt-5(data-aos="fade-right") Estos son los ensayos fisicoquímicos más importantes realizados a los productos farmacéuticos, porque se busca determinar que la cantidad del principio activo es el apropiado, el producto se disuelve correctamente, lo que garantiza su adecuada absorción y que haya una uniformidad en la dosificación. Sin embargo, no son los únicos que se aplican en las distintas formas farmacéuticas de los preparados magistrales. 
    p.mt-4(data-aos="fade-right") La calidad de un preparado magistral no estéril puede tener ciertas desviaciones con respecto a los estándares requeridos. Cuando se lleva a cabo el control de calidad de estos productos, es de vital importancia que se aseguren los siguientes aspectos:

    .row.justify-content-center.mt-5
      .col-lg-1.d-lg-flex.d-none
      .col-lg-3.col-6.mb-4.mb-lg-0
        figure.text-center
          img(src="@/assets/curso/tema4/10.svg" data-aos="zoom-in" style="display:inline;max-width:450px;" alt="Imagen decorativa")
      .col-lg-4.mb-4.mb-lg-0
        .tarjeta-numerada.color-acento-contenido.p-5.d-flex.align-items-center(data-aos="fade-right" style="height:100%;")
          .tarjeta-numerada__numero
            .h2(style="color:#12263F;") 1
          p Garantizar que la calidad del análisis cumpla con los estándares requeridos.
      .col-lg-4.mb-4.mb-lg-0
    ...
    .col-lg-8.mt-5.m-auto(data-aos="fade-up")
      .cajon.color-secundario.p-4(style="background-color:#E4DDFA;")
        p.mb-0 También se pueden utilizar otros métodos con el mismo objetivo y, en ese caso, la nueva técnica o sus modificaciones sencillas deben validarse.
    
    Separador
    #t_4_2.titulo-segundo(data-aos="fade-right")
      h2 4.2 Validación de los métodos de ensayo
    ...
    .row.justify-content-center
      ...
      .col-lg-5(style="place-self:center;position:relative;")
        .cont_responsive2.p-4(style="position:relative;width:140%;background-color:#F6F6F6;border-radius:0px 20px 20px 0px;left:-270px;box-shadow:0px 0px 20px rgba(0,0,0,.1)" )
          p(data-aos="fade-left") Para que un método analítico se considere como validado y aprobado, es fundamental que cumpla con unos parámetros estadísticos debidamente documentados y comprobados. La documentación para validar los métodos de ensayo está compuesta por tres elementos:
          ul.fa-ul.mb-0.mt-3
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
            ...
            li.mb-2(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | Reporte de análisis de validación.
            li(data-aos="fade-left")
              i.fas.fa-atom.fa-li(style="color:#FF9D00;")
              | Informe de validación. 
    
    p.mt-5(data-aos="fade-right") Se debe realizar un análisis del método de acuerdo con el protocolo de validación; validar un método analítico es demostrar que dicho método es idóneo para la utilidad que se le va a dar. Las características de validación más comunes son: 

    TabsC.color-secundario.mt-5(data-aos="zoom-in")
        ...
        .row.justify-content-center
          .col-lg-6.order-lg-1.order-2
            ...
            ul.fa-ul.mb-0.mt-3
              li.mb-2
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
                | Imposibilitar su inequívoca identificación. 
              li
                i.fas.fa-atom.fa-li(style="color:#7E5EE3;")
    ...
    #t_4_3.titulo-segundo(data-aos="fade-right")
      h2 4.3 Ensayos según formas farmacéuticas de los preparados magistrales
    ...
    .tarjeta.tarjeta--gris.p-4.mt-5(data-aos="zoom-in")
      LineaTiempoC.color-secundario
        ...
        .row.justify-content-center(titulo="pH")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
        ...
        .row.justify-content-center(titulo="Viscocidad")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
        ...
        .row.justify-content-center(titulo="Valoración")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
        ...
        .row.justify-content-center(titulo="Control")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
        ...
        .row.justify-content-center(titulo="Ensayo")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
        ...
        .row.justify-content-center(titulo="Uniformidad")
          .col-lg-6.col-10.mb-lg-0.mb-4
            figure
    ...
    p.mt-5(data-aos="fade-right") Las pruebas o ensayos que se describen a continuación, son tipos de ensayos fisicoquímicos que brindan información con respecto a la calidad del preparado magistral. Dentro de los tipos de ensayos que existen para las formas farmacéuticas tópicas no estériles están (ver tabla 1):

    .titulo-sexto.color-acento-botones.mt-5(data-aos="fade-right")
      h5 Tabla 1.
      span Ensayos de formas farmacéuticas
    
    .tabla-a.color-acento-contenido.mt-5
      table
        thead
          tr(style="background-color:#C4F4FA;" data-aos="fade-right")
            th.p-4(style="border:0;") Ensayos realizados a #[br] formas farmacéuticas
            th.p-4(style="border:0;") Forma farmacéutica
            th.p-4(style="border:0;") Pruebas
        tbody
          tr(data-aos="fade-right")
            ...
            td.p-4(style="border:0;") 
              ul.fa-ul.mb-0
                ...
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Viscosidad (emulsiones y suspensiones).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                ...
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Valoración de (o los) principios activos.
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Ensayo productos de degradación (si procede).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Control microbiológico.
          tr(data-aos="fade-right")
            td.p-4.text-center(style="border:0;border-right:1px #E1E1E1 solid;background-color:#B3E0F4;")
              h5(style="transform: rotate(-90deg)") Sólidas
            td.p-4.text-center(style="border:0;border-right:1px #E1E1E1 solid;background-color:#E6EDF0;") Granulados y polvos orales, tópicos y para reconstituir.
            td.p-4(style="border:0;background-color:#E6EDF0;") 
              ul.fa-ul.mb-0
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Características organolépticas.
                ...
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Control de volumen (formas liquidas).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Control peso (formas solidas).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Identidad y valoración del principio activo.
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Análisis de productos de degradación (si procede).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Ensayo de disolución (si procede).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Control microbiológico.
                li.mb-3
          ...
          tr(data-aos="fade-right")
            td.p-4.text-center(style="border:0;border-right:1px #E1E1E1 solid;background-color:#F3F3F3;" rowspan="2")
              h5(style="transform: rotate(-90deg)") Semisólidas
            td.p-4.text-center(style="border:0;border-right:1px #E1E1E1 solid;") Supositorios, óvulos.
            td.p-4(style="border:0;") 
              ul.fa-ul.mb-0
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Descripción (forma, color, etc.).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Dimensiones.
                li.mb-3
                ...
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Identidad y valoración del (o los) principios activos.
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Uniformidad de dosis.
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Ensayo de productos de degradación (si procede).
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
                  | Control microbiológico.
          tr(data-aos="fade-right")
            td.p-4.text-center(style="border:0;border-right:1px #E1E1E1 solid;background-color:#FAFAFA;") Ungüentos, cremas, geles y pastas.
            td.p-4(style="border:0;background-color:#FAFAFA;") 
              ul.fa-ul.mb-0
                li.mb-3
                  i.fas.fa-atom.fa-li(style="color:#FF9D00;")
    ...
    .col-lg-10.m-auto.mt-5
      .row.p-4.p-md-2(style="background-color:#7E5EE3;border-radius:10px;" data-aos="zoom-in")
        ...
        .col-lg-3.col-md-3.text-center(style="place-self:center;")
          a.boton.color-acento-botones(:href="obtenerLink('downloads/Anexo2_CF022_Control_de_calidad_magistrales_dermatológicos.pdf')" target="_blank" type="application/pdf")
...
.cont_4_2:before
  ...
  left: -15%
  bottom: 0
  background: url(../assets/curso/tema4/17.png)
  background-size: cover
